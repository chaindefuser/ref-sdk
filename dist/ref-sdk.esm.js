    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 22:
            tx = transactions.createTransaction(AccountId, utils.PublicKey.from(publicKey.toString()), transactions$1[i].receiverId, Number(accessKey.nonce) + i + 1, transaction.actions.map(function (action) {
