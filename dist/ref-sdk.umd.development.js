(function (global, factory) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 22:
              tx = nearApiJs.transactions.createTransaction(AccountId, nearApiJs.utils.PublicKey.from(publicKey.toString()), transactions[i].receiverId, Number(accessKey.nonce) + i + 1, transaction.actions.map(function (action) {
                ...
                return nearApiJs.transactions.functionCall(methodName, args, BigInt(gas), BigInt(deposit));
  ...
  var _account;
  var init_env = function init_env(env, account, indexerUrl, nodeUrl) {
    _account = account;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", _account.viewFunction({
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", _account.viewFunction({
                contractId: tokenId,
                methodName: methodName,
                args: args
              }));
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              throw DCLInValid;
            case 3:
              return _context10.abrupt("return", _account.viewFunction({
